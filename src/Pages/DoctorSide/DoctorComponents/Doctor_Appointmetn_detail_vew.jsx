            ...
            <div className="relative">
                {isAddPrescriptionOpen && (
                    <div className="fixed inset-0 flex items-center justify-center z-50 shadow">
                        <div className="absolute inset-0 bg-gray-600 bg-opacity-25 backdrop-blur-[3px]" onClick={() => setIsAddPrescriptionOpen(false)}></div>
                        (
                            ...
                            <div className='w-full h-5/6 bg-gray-300 rounded-[10px] '>
                                ...
                                <div className='w-full h-1/6 '>
                                    <div className='w-full h-full flex items-center justify-center '>
                                        <button className='bg-green-500 px-3 py-2 text-center text-white rounded-[6px] '>Submit</button>
                                    </div>
                                </div>
                            </div>
                        </div>
