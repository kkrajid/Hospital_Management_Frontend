    ...
    <div className="w-full h-[96px] bg-white border-b">
        <div className="md:max-w-[1480px] max-w-[600px] w-full h-full  m-auto flex justify-between items-center">
            ...
            <div className='hidden md:flex '>
                <button className='flex gap-2 justify-between items-center bg-transparent px-6'>
                    <img src={lock} alt="" />
                    Login</button>
                <button className='px-8 py-3 bg-[#355FCF] rounded-md text-white font-bold'>Sign Up</button>
            </div>
        ...
        <div className={toggle?'absolute z-10 p-4 bg-white w-full px-8 md:hidden':'hidden'}>
            <ul>
                ...
                <div className='flex flex-col my-4 gap-4'>
                    <button className='flex gap-2 justify-center border border-[208486]  items-center bg-transparent px-6 py-4'>
                        <img src={lock} alt="" />
                        Login</button>
                    <button className='px-8 py-5 bg-[#355FCF] rounded-md text-white font-bold'>Sign Up</button>
                </div>
            </ul>
